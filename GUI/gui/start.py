...
class start(QWidget):
    ...
    def main(self):
        ...
        self.left_btn.setIconSize(QSize(60, 60))
        self.up_btn.setIconSize(QSize(60, 60))
        self.bottom_btn.setIconSize(QSize(60, 60))
        self.right_btn.setIconSize(QSize(60, 60))
    ...
    def enter2_text(self):
        ...
        self.enter2.setDisabled(True)
        self.a_coor.setDisabled(True)
        self.a_dire.setDisabled(True)
        # print (co, d)
